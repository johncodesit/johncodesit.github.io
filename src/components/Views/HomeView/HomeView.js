...
export default function HomeView(props) {
  ...
  const planetImagesArray = [
    {name:"Tatooine", image:"https://www.universeguide.com/small/planet/tatooine.jpg"},
    {name:"Alderaan", image:"https://miriamseidel.com/wp-content/uploads/2017/01/SnowballPlanet.jpg"},
    {name:"Yavin IV", image:"https://pbs.twimg.com/media/ESilZ_OWsAM-Hpn.jpg"},
    {name:"Hoth", image:"https://i.pinimg.com/originals/e0/c9/bd/e0c9bd2e3166c58a9aea8bb85f20e8a9.jpg"},
    {name:"Dagobah", image:"https://i.pinimg.com/originals/72/76/16/727616fdc990d43935ce284c695000d0.jpg"},
    {name:"Bespin", image:"https://www.astrobio.net/wp-content/uploads/2005/06/Gallery_Image_728.jpg"},
    {name:"Endor", image:"http://pm1.narvii.com/6269/ebf3db35056888752725c16026eea8e971dca4ec_00.jpg"},
    {name:"Naboo", image:"https://i.pinimg.com/originals/d0/6a/a4/d06aa46571fddea9ee58c841d996fe47.jpg"},
    {name:"Coruscant", image:"https://i.pinimg.com/originals/17/a3/fd/17a3fdc7ac714ea17be17824fcd3ca83.jpg"},
    {name:"Kamino", image:"http://holocron.swcombine.com/images/1/1e/Kamino-Planet-Holocron.png"},
  ];
  ...
  function handlePlanetChange(e, data) {
    ...
    setSelectedPlanetImage(planetImagesArray.find(element => element.name === data.props.value));
    setOpenModal(true);
  }
